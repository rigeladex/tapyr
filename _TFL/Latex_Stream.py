...
class Latex_Stream (Formatted_Stream) :
    ...
    def _caption_label (self, cap, lab) :
      if cap:
        self.putl (caption (cap))
      if lab:
        self.putl (label (lab))
    ...
    def begin_figure (self, caption = None, label = None) :
        self._begin_block ("figure", "[htp]")
        self._caption_label (caption, label)
    # end def begin_figure
    
    def end_figure (self, caption = None, label = None) :
        self._caption_label (caption, label)
