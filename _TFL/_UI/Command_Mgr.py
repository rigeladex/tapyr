...
__test__ = dict \
    ( dyn_trailing = """
        ...
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
    ...
    , dyn_middle = """
        ...
        >>> mb.activate ()
          ...
          5 : (callback = 3, name = 'Dyn-3')
          6 : (is_sep = '--------------------', name = 'sep_7')
          7 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
          3 : (callback = 4, name = 'Dyn-4')
          4 : (is_sep = '--------------------', name = 'sep_5')
          5 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
          ...
          4 : (callback = 6, name = 'Dyn-6')
          5 : (is_sep = '--------------------', name = 'sep_6')
          6 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
          3 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
    ...
    , dyn_leading = """
        ...
        >>> mb.activate ()
          ...
          2 : (callback = 3, name = 'Dyn-3')
          3 : (is_sep = '--------------------', name = 'Dyn-A')
          4 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = 4, name = 'Dyn-4')
          1 : (is_sep = '--------------------', name = 'Dyn-A')
          2 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = 5, name = 'Dyn-5')
          1 : (callback = 6, name = 'Dyn-6')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
        ...
        >>> mb.activate ()
          0 : (is_sep = '--------------------', name = 'Dyn-A')
          1 : (callback = <Command Third>, name = 'Third')
        >>> mb.activate ()
          0 : (callback = 1, name = 'Dyn-1')
          1 : (callback = 2, name = 'Dyn-2')
          2 : (callback = 3, name = 'Dyn-3')
    ...
    , dyn_2_middle = """
        ...
        >>> mb.activate ()
         ...
         11 : (callback = <Command Fourt>, name = 'Fourt')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
        ...
        >>> mb.activate ()
          ...
          6 : (callback = <Command Third>, name = 'Third')
          7 : (is_sep = '--------------------', name = 'Dyn-B')
          8 : (callback = <Command Fourt>, name = 'Fourt')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
          ...
          6 : (is_sep = '--------------------', name = 'sep_7')
          7 : (callback = <Command Fourt>, name = 'Fourt')
        >>> mb.activate ()
          0 : (callback = <Command First>, name = 'First')
          1 : (callback = <Command Secnd>, name = 'Secnd')
          2 : (is_sep = '--------------------', name = 'Dyn-A')
         ...
         13 : (callback = <Command Fourt>, name = 'Fourt')
        """
    , dyn_2_only = """
        >>> from _TFL._TKT.Command_Interfacer import _Test_CI_
        >>> import _TFL._TKT._Batch
