...
Doctest for TFL.Ticker ::
    ...
    ...    )
    >>> for b in bases :
    ...     print ("%-26s %s" % (b, b.sub_ticks))
     4 : (1, 2, 4)             [(1, 1), (0, 1), (1, 1)]
     6 : (1, 2, 3, 6)          [(1, 2), (0, 1), (0, 2), (1, 2)]
     8 : (1, 2, 4, 8)          [(1, 3), (0, 1), (1, 1), (1, 3)]
    10 : (1, 2, 5, 10)         [(1, 4), (0, 1), (0, 4), (1, 4)]
    12 : (1, 3, 6, 12)         [(3, 2), (0, 2), (1, 2), (3, 2)]
    12 : (1, 2, 3, 4, 6, 12)   [(3, 2), (0, 1), (0, 2), (0, 3), (1, 2), (3, 2)]
    16 : (1, 4, 8, 16)         [(3, 3), (1, 1), (1, 3), (3, 3)]
    16 : (1, 2, 4, 8, 16)      [(1, 7), (0, 1), (1, 1), (1, 3), (1, 7)]
    24 : (1, 3, 6, 12, 24)     [(7, 2), (0, 2), (1, 2), (3, 2), (7, 2)]
    28 : (1, 7, 14, 28)        [(3, 6), (0, 6), (1, 6), (3, 6)]
    52 : (1, 2, 4, 13, 26, 52) [(2, 12), (0, 1), (1, 1), (0, 12), (1, 12), (2, 12)]
    ...
    === 6 : (1, 2, 3, 6) ========================================
    (-320000, 420000)    -->  6 ^ +7 : 279936, 559872, 839808, 1.67962e+06
    (-3200, 4200)        -->  6 ^ +4 : 1296, 2592, 3888, 7776
    (-320, 420)          -->  6 ^ +3 : 216, 432, 648, 1296
    (-32, 42)            -->  6 ^ +1 : 6, 12, 18, 36
    (-3.2, 4.2)          -->  6 ^ +0 : 1, 2, 3, 6
    ...
    (0, 10)              -->  6 ^ +0 : 1, 2, 3, 6
    (0, 40)              -->  6 ^ +1 : 6, 12, 18, 36
    (0, 100)             -->  6 ^ +2 : 36, 72, 108, 216
    (0, 400)             -->  6 ^ +2 : 36, 72, 108, 216
    (0, 1000)            -->  6 ^ +3 : 216, 432, 648, 1296
    (0, 4000)            -->  6 ^ +4 : 1296, 2592, 3888, 7776
    (0, 10000)           -->  6 ^ +4 : 1296, 2592, 3888, 7776
    (0, 400000)          -->  6 ^ +6 : 46656, 93312, 139968, 279936
    (0, 1000000)         -->  6 ^ +7 : 279936, 559872, 839808, 1.67962e+06
    ...
    (0.1, 36.5)          -->  6 ^ +1 : 6, 12, 18, 36
    (0.132, 0.244)       -->  6 ^ -2 : 0.0277778, 0.0555556, 0.0833333, 0.166667
    (1, 5)               -->  6 ^ +0 : 1, 2, 3, 6
    (1, 12)              -->  6 ^ +0 : 1, 2, 3, 6
    (1, 365)             -->  6 ^ +2 : 36, 72, 108, 216
    (1.32, 2.44)         -->  6 ^ -1 : 0.166667, 0.333333, 0.5, 1
    (10, 50)             -->  6 ^ +1 : 6, 12, 18, 36
    (10, 120)            -->  6 ^ +2 : 36, 72, 108, 216
    (10, 3650)           -->  6 ^ +4 : 1296, 2592, 3888, 7776
    (13.2, 24.4)         -->  6 ^ +0 : 1, 2, 3, 6
    (100, 500)           -->  6 ^ +2 : 36, 72, 108, 216
    (100, 1200)          -->  6 ^ +3 : 216, 432, 648, 1296
    (100, 36500)         -->  6 ^ +5 : 7776, 15552, 23328, 46656
    (132, 244)           -->  6 ^ +2 : 36, 72, 108, 216
    (10000, 50000)       -->  6 ^ +5 : 7776, 15552, 23328, 46656
    (10000, 120000)      -->  6 ^ +5 : 7776, 15552, 23328, 46656
    (10000, 3650000)     -->  6 ^ +7 : 279936, 559872, 839808, 1.67962e+06
    (13200, 24400)       -->  6 ^ +4 : 1296, 2592, 3888, 7776
    === 10 : (1, 2, 5, 10) ========================================
    (-320000, 420000)    --> 10 ^ +5 : 100000, 200000, 500000, 1e+06
    (-3200, 4200)        --> 10 ^ +3 : 1000, 2000, 5000, 10000
    (-320, 420)          --> 10 ^ +2 : 100, 200, 500, 1000
    (-32, 42)            --> 10 ^ +1 : 10, 20, 50, 100
    ...
    (0, 4)               --> 10 ^ +0 : 1, 2, 5, 10
    (0, 10)              --> 10 ^ +0 : 1, 2, 5, 10
    (0, 40)              --> 10 ^ +1 : 10, 20, 50, 100
    (0, 100)             --> 10 ^ +1 : 10, 20, 50, 100
    (0, 400)             --> 10 ^ +2 : 100, 200, 500, 1000
    (0, 1000)            --> 10 ^ +2 : 100, 200, 500, 1000
    (0, 4000)            --> 10 ^ +3 : 1000, 2000, 5000, 10000
    (0, 10000)           --> 10 ^ +3 : 1000, 2000, 5000, 10000
    (0, 400000)          --> 10 ^ +5 : 100000, 200000, 500000, 1e+06
    (0, 1000000)         --> 10 ^ +5 : 100000, 200000, 500000, 1e+06
    ...
    (0.1, 36.5)          --> 10 ^ +1 : 10, 20, 50, 100
    (0.132, 0.244)       --> 10 ^ -2 : 0.01, 0.02, 0.05, 0.1
    (1, 5)               --> 10 ^ +0 : 1, 2, 5, 10
    (1, 12)              --> 10 ^ +0 : 1, 2, 5, 10
    (1, 365)             --> 10 ^ +2 : 100, 200, 500, 1000
    (1.32, 2.44)         --> 10 ^ -1 : 0.1, 0.2, 0.5, 1
    (10, 50)             --> 10 ^ +1 : 10, 20, 50, 100
    (10, 120)            --> 10 ^ +1 : 10, 20, 50, 100
    (10, 3650)           --> 10 ^ +3 : 1000, 2000, 5000, 10000
    (13.2, 24.4)         --> 10 ^ +0 : 1, 2, 5, 10
    (100, 500)           --> 10 ^ +2 : 100, 200, 500, 1000
    (100, 1200)          --> 10 ^ +2 : 100, 200, 500, 1000
    (100, 36500)         --> 10 ^ +4 : 10000, 20000, 50000, 100000
    (132, 244)           --> 10 ^ +1 : 10, 20, 50, 100
    (10000, 50000)       --> 10 ^ +4 : 10000, 20000, 50000, 100000
    (10000, 120000)      --> 10 ^ +4 : 10000, 20000, 50000, 100000
    (10000, 3650000)     --> 10 ^ +6 : 1e+06, 2e+06, 5e+06, 1e+07
    (13200, 24400)       --> 10 ^ +3 : 1000, 2000, 5000, 10000
    === 12 : (1, 3, 6, 12) ========================================
    (-320000, 420000)    --> 12 ^ +4 : 20736, 62208, 124416, 248832
    (-3200, 4200)        --> 12 ^ +2 : 144, 432, 864, 1728
    (-320, 420)          --> 12 ^ +1 : 12, 36, 72, 144
    (-32, 42)            --> 12 ^ +0 : 1, 3, 6, 12
    ...
    (0, 40)              --> 12 ^ +0 : 1, 3, 6, 12
    (0, 100)             --> 12 ^ +0 : 1, 3, 6, 12
    (0, 400)             --> 12 ^ +1 : 12, 36, 72, 144
    (0, 1000)            --> 12 ^ +1 : 12, 36, 72, 144
    (0, 4000)            --> 12 ^ +2 : 144, 432, 864, 1728
    (0, 10000)           --> 12 ^ +2 : 144, 432, 864, 1728
    (0, 400000)          --> 12 ^ +4 : 20736, 62208, 124416, 248832
    (0, 1000000)         --> 12 ^ +4 : 20736, 62208, 124416, 248832
    ...
    (1, 365)             --> 12 ^ +1 : 12, 36, 72, 144
    (1.32, 2.44)         --> 12 ^ -1 : 0.0833333, 0.25, 0.5, 1
    (10, 50)             --> 12 ^ +0 : 1, 3, 6, 12
    (10, 120)            --> 12 ^ +0 : 1, 3, 6, 12
    (10, 3650)           --> 12 ^ +2 : 144, 432, 864, 1728
    (13.2, 24.4)         --> 12 ^ -1 : 0.0833333, 0.25, 0.5, 1
    (100, 500)           --> 12 ^ +1 : 12, 36, 72, 144
    (100, 1200)          --> 12 ^ +1 : 12, 36, 72, 144
    (100, 36500)         --> 12 ^ +3 : 1728, 5184, 10368, 20736
    (132, 244)           --> 12 ^ +0 : 1, 3, 6, 12
    (10000, 50000)       --> 12 ^ +3 : 1728, 5184, 10368, 20736
    (10000, 120000)      --> 12 ^ +3 : 1728, 5184, 10368, 20736
    (10000, 3650000)     --> 12 ^ +5 : 248832, 746496, 1.49299e+06, 2.98598e+06
    (13200, 24400)       --> 12 ^ +2 : 144, 432, 864, 1728
    === 16 : (1, 2, 4, 8, 16) ========================================
    (-320000, 420000)    --> 16 ^ +4 : 65536, 131072, 262144, 524288, 1.04858e+06
    (-3200, 4200)        --> 16 ^ +2 : 256, 512, 1024, 2048, 4096
    (-320, 420)          --> 16 ^ +1 : 16, 32, 64, 128, 256
    (-32, 42)            --> 16 ^ +1 : 16, 32, 64, 128, 256
    ...
    (0, 100)             --> 16 ^ +1 : 16, 32, 64, 128, 256
    (0, 400)             --> 16 ^ +1 : 16, 32, 64, 128, 256
    (0, 1000)            --> 16 ^ +1 : 16, 32, 64, 128, 256
    (0, 4000)            --> 16 ^ +2 : 256, 512, 1024, 2048, 4096
    (0, 10000)           --> 16 ^ +2 : 256, 512, 1024, 2048, 4096
    (0, 400000)          --> 16 ^ +4 : 65536, 131072, 262144, 524288, 1.04858e+06
    (0, 1000000)         --> 16 ^ +4 : 65536, 131072, 262144, 524288, 1.04858e+06
    ...
    (10, 120)            --> 16 ^ +1 : 16, 32, 64, 128, 256
    (10, 3650)           --> 16 ^ +2 : 256, 512, 1024, 2048, 4096
    (13.2, 24.4)         --> 16 ^ +0 : 1, 2, 4, 8, 16
    (100, 500)           --> 16 ^ +1 : 16, 32, 64, 128, 256
    (100, 1200)          --> 16 ^ +2 : 256, 512, 1024, 2048, 4096
    (100, 36500)         --> 16 ^ +3 : 4096, 8192, 16384, 32768, 65536
    (132, 244)           --> 16 ^ +1 : 16, 32, 64, 128, 256
    (10000, 50000)       --> 16 ^ +3 : 4096, 8192, 16384, 32768, 65536
    ...
    ===  6 : (1, 2, 3, 6) =======================================================
    (-320000, 420000)    :       279936 ->  2 *       139968 ->  3 *        46656
    (-3200, 4200)        :         1296 ->  2 *          648 ->  3 *          216
    (-320, 420)          :          216 ->  2 *          108 ->  3 *           36
    (-32, 42)            :            6 ->  2 *            3 ->  3 *            1
    ...
    (0, 100)             :           36 ->  2 *           18 ->  3 *            6
    (0, 400)             :           36 ->  2 *           18 ->  3 *            6
    (0, 1000)            :          216 ->  2 *          108 ->  3 *           36
    (0, 4000)            :         1296 ->  2 *          648 ->  3 *          216
    (0, 10000)           :         1296 ->  2 *          648 ->  3 *          216
    (0, 400000)          :        46656 ->  2 *        23328 ->  3 *         7776
    (0, 1000000)         :       279936 ->  2 *       139968 ->  3 *        46656
    ...
    (10, 50)             :            6 ->  2 *            3 ->  3 *            1
    (10, 120)            :           36 ->  2 *           18 ->  3 *            6
    (10, 3650)           :         1296 ->  2 *          648 ->  3 *          216
    (13.2, 24.4)         :            1 ->  2 *          0.5 ->  3 *     0.166667
    (100, 500)           :           36 ->  2 *           18 ->  3 *            6
    (100, 1200)          :          216 ->  2 *          108 ->  3 *           36
    (100, 36500)         :         7776 ->  2 *         3888 ->  3 *         1296
    (132, 244)           :           36 ->  2 *           18 ->  3 *            6
    (10000, 50000)       :         7776 ->  2 *         3888 ->  3 *         1296
    (10000, 120000)      :         7776 ->  2 *         3888 ->  3 *         1296
    (10000, 3650000)     :       279936 ->  2 *       139968 ->  3 *        46656
    (13200, 24400)       :         1296 ->  2 *          648 ->  3 *          216
    === 10 : (1, 2, 5, 10) =======================================================
    ...
    (0, 4000)            :         1000 ->  2 *          500 ->  5 *          100
    (0, 10000)           :         1000 ->  2 *          500 ->  5 *          100
    (0, 400000)          :       100000 ->  2 *        50000 ->  5 *        10000
    (0, 1000000)         :       100000 ->  2 *        50000 ->  5 *        10000
    (0.0001, 0.0005)     :       0.0001 ->  2 *        5e-05 ->  5 *        1e-05
    (0.0001, 0.0012)     :       0.0001 ->  2 *        5e-05 ->
    (0.0001, 0.0365)     :         0.01 ->  2 *        0.005 ->  5 *        0.001
    (0.000132, 0.000244) :        1e-05 ->  2 *        5e-06 ->
    (0.01, 0.05)         :         0.01 ->  2 *        0.005 ->  5 *        0.001
    (0.01, 0.12)         :         0.01 ->  2 *        0.005 ->
    (0.01, 3.65)         :            1 ->  2 *          0.5 ->  5 *          0.1
    (0.0132, 0.0244)     :        0.001 ->  2 *       0.0005 ->
    (0.1, 0.5)           :          0.1 ->  2 *         0.05 ->  5 *         0.01
    (0.1, 1.2)           :          0.1 ->  2 *         0.05 ->
    (0.1, 36.5)          :           10 ->  2 *            5 ->  5 *            1
    (0.132, 0.244)       :         0.01 ->  2 *        0.005 ->
    (1, 5)               :            1 ->  2 *          0.5 ->  5 *          0.1
    (1, 12)              :            1 ->  2 *          0.5 ->  5 *          0.1
    (1, 365)             :          100 ->  2 *           50 ->  5 *           10
    (1.32, 2.44)         :          0.1 ->  2 *         0.05 ->
    (10, 50)             :           10 ->  2 *            5 ->  5 *            1
    (10, 120)            :           10 ->  2 *            5 ->  5 *            1
    (10, 3650)           :         1000 ->  2 *          500 ->  5 *          100
    (13.2, 24.4)         :            1 ->  2 *          0.5 ->
    (100, 500)           :          100 ->  2 *           50 ->  5 *           10
    (100, 1200)          :          100 ->  2 *           50 ->  5 *           10
    (100, 36500)         :        10000 ->  2 *         5000 ->  5 *         1000
    (132, 244)           :           10 ->  2 *            5 ->
    (10000, 50000)       :        10000 ->  2 *         5000 ->  5 *         1000
    (10000, 120000)      :        10000 ->  2 *         5000 ->  5 *         1000
    (10000, 3650000)     :        1e+06 ->  2 *       500000 ->  5 *       100000
    (13200, 24400)       :         1000 ->  2 *          500 ->
    === 12 : (1, 3, 6, 12) =======================================================
    (-320000, 420000)    :        62208 ->  4 *        15552 ->
    (-3200, 4200)        :          432 ->  4 *          108 ->
    (-320, 420)          :           72 ->  4 *           18 ->
    (-32, 42)            :            6 ->  2 *            3 ->  3 *            1
    (-3.2, 4.2)          :            1 ->                   ->
    ...
    (10, 50)             :            3 ->  3 *            1 ->
    (10, 120)            :            6 ->  2 *            3 ->  3 *            1
    (10, 3650)           :          432 ->  4 *          108 ->  3 *           36
    (13.2, 24.4)         :            1 ->                   ->
    (100, 500)           :           36 ->  4 *            9 ->
    (100, 1200)          :           72 ->  4 *           18 ->
    (100, 36500)         :         5184 ->  4 *         1296 ->  3 *          432
    (132, 244)           :            6 ->  2 *            3 ->  3 *            1
    (10000, 50000)       :         5184 ->  4 *         1296 ->  3 *          432
    (10000, 120000)      :        10368 ->  4 *         2592 ->
    (10000, 3650000)     :       248832 ->  4 *        62208 ->
    (13200, 24400)       :          864 ->  4 *          216 ->
    === 16 : (1, 2, 4, 8, 16) =======================================================
    (-320000, 420000)    :        65536 ->  2 *        32768 ->
    (-3200, 4200)        :          512 ->  2 *          256 ->
    (-320, 420)          :           64 ->  2 *           32 ->
    (-32, 42)            :           16 ->  2 *            8 ->  8 *            1
    (-3.2, 4.2)          :            1 ->  2 *          0.5 ->
    (-0.32, 0.42)        :       0.0625 ->  2 *      0.03125 ->
    (-0.0032, 0.0042)    :  0.000488281 ->  2 *  0.000244141 ->
    (0, 0.004)           :  0.000244141 ->  2 *   0.00012207 ->
    (0, 0.01)            :  0.000976562 ->  2 *  0.000488281 ->
    (0, 0.4)             :       0.0625 ->  2 *      0.03125 ->
    (0, 1)               :       0.0625 ->  2 *      0.03125 ->
    (0, 4)               :         0.25 ->  2 *        0.125 ->
    (0, 10)              :            1 ->  2 *          0.5 ->
    (0, 40)              :            2 ->  2 *            1 ->  2 *          0.5
    (0, 100)             :           16 ->  2 *            8 ->
    ...
    (0, 4000)            :          256 ->  2 *          128 ->
    (0, 10000)           :          512 ->  2 *          256 ->
    (0, 400000)          :        65536 ->  2 *        32768 ->
    (0, 1000000)         :        65536 ->  2 *        32768 ->
    (0.0001, 0.0005)     :  3.05176e-05 ->  2 *  1.52588e-05 ->
    (0.0001, 0.0012)     :  0.000244141 ->  2 *   0.00012207 ->  8 *  1.52588e-05
    (0.0001, 0.0365)     :       0.0625 ->  2 *      0.03125 ->  8 *   0.00390625
    (0.000132, 0.000244) :  1.52588e-05 ->  2 *  7.62939e-06 ->
    (0.01, 0.05)         :   0.00390625 ->  2 *   0.00195312 ->
    (0.01, 0.12)         :    0.0078125 ->  2 *   0.00390625 ->
    (0.01, 3.65)         :         0.25 ->  2 *        0.125 ->
    (0.0132, 0.0244)     :  0.000976562 ->  2 *  0.000488281 ->
    (0.1, 0.5)           :       0.0625 ->  2 *      0.03125 ->
    (0.1, 1.2)           :       0.0625 ->  2 *      0.03125 ->
    (0.1, 36.5)          :            2 ->  2 *            1 ->  2 *          0.5
    (0.132, 0.244)       :    0.0078125 ->  2 *   0.00390625 ->
    (1, 5)               :         0.25 ->  2 *        0.125 ->
    (1, 12)              :            1 ->  2 *          0.5 ->
    (1, 365)             :           32 ->  2 *           16 ->
    (1.32, 2.44)         :       0.0625 ->  2 *      0.03125 ->
    (10, 50)             :            2 ->  2 *            1 ->  2 *          0.5
    (10, 120)            :           16 ->  2 *            8 ->
    (10, 3650)           :          256 ->  2 *          128 ->
    (13.2, 24.4)         :            1 ->  2 *          0.5 ->
    (100, 500)           :           32 ->  2 *           16 ->
    (100, 1200)          :          256 ->  2 *          128 ->  8 *           16
    (100, 36500)         :         4096 ->  2 *         2048 ->
    (132, 244)           :           16 ->  2 *            8 ->
    (10000, 50000)       :         4096 ->  2 *         2048 ->
    (10000, 120000)      :         8192 ->  2 *         4096 ->
    (10000, 3650000)     :       262144 ->  2 *       131072 ->
    (13200, 24400)       :         1024 ->  2 *          512 ->
    ...
    (10000, 120000)      :  6 ^ +5 [1]   9 * 15552
    (10000, 3650000)     :  6 ^ +7 [1]   8 * 559872
    (13200, 24400)       :  6 ^ +4 [1]   6 * 2592
    ...
    (0, 10000)           : 10 ^ +3 [1]   6 * 2000
    (0, 400000)          : 10 ^ +5 [0]   5 * 100000
    (0, 1000000)         : 10 ^ +5 [1]   6 * 200000
    ...
    (-320000, 420000)    : 12 ^ +4 [2]   8 * 124416
    (-3200, 4200)        : 12 ^ +2 [3]   6 * 1728
    (-320, 420)          : 12 ^ +1 [3]   7 * 144
    (-32, 42)            : 12 ^ +0 [3]   8 * 12
    (-3.2, 4.2)          : 12 ^ -1 [3]  10 * 1
    ...
    (0, 1000)            : 12 ^ +1 [3]   8 * 144
    (0, 4000)            : 12 ^ +2 [2]   6 * 864
    (0, 10000)           : 12 ^ +2 [3]   7 * 1728
    (0, 400000)          : 12 ^ +4 [1]   8 * 62208
    (0, 1000000)         : 12 ^ +4 [3]   6 * 248832
    ...
    (10, 50)             : 12 ^ +0 [2]   9 * 6
    (10, 120)            : 12 ^ +0 [3]  11 * 12
    (10, 3650)           : 12 ^ +2 [2]   6 * 864
    (13.2, 24.4)         : 12 ^ -1 [3]  13 * 1
    (100, 500)           : 12 ^ +1 [2]   7 * 72
    (100, 1200)          : 12 ^ +1 [3]  10 * 144
    (100, 36500)         : 12 ^ +3 [1]   9 * 5184
    (132, 244)           : 12 ^ +0 [3]  11 * 12
    (10000, 50000)       : 12 ^ +3 [1]  10 * 5184
    (10000, 120000)      : 12 ^ +3 [3]   7 * 20736
    (10000, 3650000)     : 12 ^ +5 [1]   6 * 746496
    (13200, 24400)       : 12 ^ +2 [3]   9 * 1728
    === base 12 : (1, 3, 6, 12) max-ticks 20 ==============================
    (-320000, 420000)    : 12 ^ +4 [1]  14 * 62208
    (-3200, 4200)        : 12 ^ +2 [1]  19 * 432
    (-320, 420)          : 12 ^ +1 [2]  12 * 72
    (-32, 42)            : 12 ^ +0 [2]  14 * 6
    (-3.2, 4.2)          : 12 ^ -1 [3]  10 * 1
    (-0.32, 0.42)        : 12 ^ -1 [3]   3 * 1
    (0, 0.4)             : 12 ^ -1 [3]   2 * 1
    ...
    (0, 400)             : 12 ^ +1 [1]  13 * 36
    (0, 1000)            : 12 ^ +1 [2]  15 * 72
    (0, 4000)            : 12 ^ +2 [1]  11 * 432
    (0, 10000)           : 12 ^ +2 [2]  13 * 864
    (0, 400000)          : 12 ^ +4 [0]  21 * 20736
    (0, 1000000)         : 12 ^ +4 [1]  18 * 62208
    (0.01, 0.12)         : 12 ^ -1 [3]   2 * 1
    (0.01, 3.65)         : 12 ^ -1 [3]   5 * 1
    (0.1, 0.5)           : 12 ^ -1 [3]   2 * 1
    (0.1, 1.2)           : 12 ^ -1 [3]   3 * 1
    ...
    (10, 50)             : 12 ^ +0 [1]  15 * 3
    (10, 120)            : 12 ^ +0 [2]  20 * 6
    (10, 3650)           : 12 ^ +2 [1]  10 * 432
    (13.2, 24.4)         : 12 ^ -1 [3]  13 * 1
    (100, 500)           : 12 ^ +1 [1]  13 * 36
    (100, 1200)          : 12 ^ +1 [2]  17 * 72
    (100, 36500)         : 12 ^ +3 [1]   9 * 5184
    (132, 244)           : 12 ^ +0 [2]  20 * 6
    (10000, 50000)       : 12 ^ +3 [1]  10 * 5184
    (10000, 120000)      : 12 ^ +3 [2]  13 * 10368
    (10000, 3650000)     : 12 ^ +5 [0]  16 * 248832
    (13200, 24400)       : 12 ^ +2 [2]  15 * 864
    ...
    [500, 1000, 1500, 2000, 3000, 3500, 4000, 4500, 5500, 6000, 6500, 7000, 8000, 8500, 9000, 9500, 10500, 11000, 11500, 12000, 13000, 13500, 14000, 14500, 15500, 16000, 16500, 17000, 18000, 18500, 19000, 19500, 20500, 21000, 21500, 22000, 23000, 23500, 24000, 24500]
    ...
    [5500, 6000, 6500, 7000, 8000, 8500, 9000, 9500, 10500, 11000, 11500, 12000, 13000, 13500, 14000, 14500, 15500, 16000, 16500, 17000, 18000, 18500, 19000, 19500]
    ...
    [1000, 2000, 3000, 4000, 6000, 7000, 8000, 9000, 11000, 12000, 13000, 14000, 16000, 17000, 18000, 19000]
    ...
    >>> print (m_0_42)
    Axis_I (Base_Integral (12, (3, 6)), 0, 42, 0, 42, 0, 20, 100)
    >>> print (m_0_42.scaled)
    12 : (1, 3, 6, 12)
    ...
    >>> print (m_0_47)
    Axis_I (Base_Integral (12, (3, 6)), 0, 47, 0, 48, 0, 20, 100)
    >>> print (m_0_47.scaled)
    12 : (1, 3, 6, 12)
    ...
    >>> print (m_1_42)
    Axis_I (Base_Integral (12, (3, 6)), 1, 42, 0, 42, 0, 20, 100)
    ...
    [0.409, 0.411, 0.412, 0.413, 0.414, 0.416, 0.417, 0.418, 0.419, 0.421, 0.422, 0.423, 0.424, 0.426, 0.427, 0.428, 0.429, 0.431, 0.432, 0.433, 0.434, 0.436, 0.437, 0.438, 0.439, 0.441, 0.442, 0.443, 0.444, 0.446, 0.447, 0.448, 0.449, 0.451]
    ...
    [0.2775, 0.2785, 0.2795, 0.2805, 0.2815]
    >>> show (y_0278_0281.minor_range)
    [0.2771, 0.2772, 0.2773, 0.2774, 0.2776, 0.2777, 0.2778, 0.2779, 0.2781, 0.2782, 0.2783, 0.2784, 0.2786, 0.2787, 0.2788, 0.2789, 0.2791, 0.2792, 0.2793, 0.2794, 0.2796, 0.2797, 0.2798, 0.2799, 0.2801, 0.2802, 0.2803, 0.2804, 0.2806, 0.2807, 0.2808, 0.2809, 0.2811, 0.2812, 0.2813, 0.2814, 0.2816, 0.2817, 0.2818, 0.2819]
    ...
    [0.272, 0.274, 0.276, 0.278, 0.282, 0.284, 0.286, 0.288]
