 ...
 *
 * Copyright (C) 2009-2010 Jordan Boesch
...
(function($){
    ...
    */
    ...
    $.gritter.Convert_Patagraphs_to_Gitter = function (class_name)
    { var $notifications = $("." + class_name);
      $notifications.remove ();
      $notifications.find ("p").each (function () {
        $.gritter.add ({ title : " ", text : $(this).html ()});
      });
    };
