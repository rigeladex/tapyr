...
_test_ancestors = """
    ...
    pap_company_has_url /4  <  mom_id_entity /5
    pap_person_has_url /4  <  mom_id_entity /5
    pap_company_has_phone /5  <  mom_id_entity /5
    pap_person_has_phone /5  <  mom_id_entity /5
    pap_company_has_email /4  <  mom_id_entity /5
    pap_person_has_email /4  <  mom_id_entity /5
    pap_company_has_address /4  <  mom_id_entity /5
    pap_person_has_address /4  <  mom_id_entity /5
...
_test_tables = """
    ...
    PAP.Company_has_Url                      pap_company_has_url                        4   3
    PAP.Person_has_Url                       pap_person_has_url                         4   3
    PAP.Company_has_Phone                    pap_company_has_phone                      5   4
    PAP.Person_has_Phone                     pap_person_has_phone                       5   4
    PAP.Company_has_Email                    pap_company_has_email                      4   3
    PAP.Person_has_Email                     pap_person_has_email                       4   3
    PAP.Company_has_Address                  pap_company_has_address                    4   3
    PAP.Person_has_Address                   pap_person_has_address                     4   3
