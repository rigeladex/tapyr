...
_test_code = """
    ...
    A MAC address must contain 6 hexadecimal octets separated by `:`.
    >>> IP4_Address ('1.2.3.4')
    GTW.OMP.NET.IP4_Address (u'1.2.3.4')
    >>> IP4_Address ('111.222.233.244')
    GTW.OMP.NET.IP4_Address (u'111.222.233.244')
    >>> IP4_Address ('111.222.233.244/22')
    Traceback (most recent call last):
     ...
    ...
    IP4 address must contain 4 decimal octets separated by `.`.
    >>> IP4_Network ('111.222.233.244/22')
    GTW.OMP.NET.IP4_Network (u'111.222.233.244/22')
    >>> IP4_Network ('1.2.3.4/22')
    GTW.OMP.NET.IP4_Network (u'1.2.3.4/22')
    >>> IP4_Network ('1.2.3.4/32')
    GTW.OMP.NET.IP4_Network (u'1.2.3.4/32')
    >>> IP4_Network ('0.0.0.0/0')
    GTW.OMP.NET.IP4_Network (u'0.0.0.0/0')
    >>> IP4_Network ('1.2.3.4/33')
    Traceback (most recent call last):
     ...
    Invariants: `Syntax error` for : `IP4-network `address``
         expected type  : `IP4-network`
         got      value : `33`
    IP4 network must contain 4 decimal octets separated by `.`, optionally followed by `/` and a number between 0 and 32.
    >>> IP4_Network ('1.2.3.4/333')
    Traceback (most recent call last):
     ...
    Invariants: `Syntax error` for : `IP4-network `address``
         expected type  : `IP4-network`
    ...
    GTW.OMP.NET.IP6_Address (u'2001:0db8:85a3:0000:0000:8a2e:0370:7334')
    >>> IP6_Address ('2001:db8:85a3:0:0:8a2e:370:7334')
    GTW.OMP.NET.IP6_Address (u'2001:db8:85a3:0:0:8a2e:370:7334')
    >>> IP6_Address ('2001:db8:85a3::8a2e:370:7334')
    GTW.OMP.NET.IP6_Address (u'2001:db8:85a3::8a2e:370:7334')
    >>> IP6_Address ('2001:0db8:0000:0000:0000:0000:1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:0000:0000:0000:0000:1428:57ab')
    >>> IP6_Address ('2001:0db8:0000:0000:0000::1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:0000:0000:0000::1428:57ab')
    >>> IP6_Address ('2001:0db8:0:0:0:0:1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:0:0:0:0:1428:57ab')
    >>> IP6_Address ('2001:0db8:0:0::1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:0:0::1428:57ab')
    >>> IP6_Address ('2001:0db8::1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:0db8::1428:57ab')
    >>> IP6_Address ('2001:db8::1428:57ab')
    GTW.OMP.NET.IP6_Address (u'2001:db8::1428:57ab')
    >>> IP6_Address ('0000:0000:0000:0000:0000:0000:0000:0001')
    GTW.OMP.NET.IP6_Address (u'0000:0000:0000:0000:0000:0000:0000:0001')
    >>> IP6_Address ('::1')
    GTW.OMP.NET.IP6_Address (u'::1')
    >>> IP6_Address ('::ffff:0c22:384e')
    GTW.OMP.NET.IP6_Address (u'::ffff:0c22:384e')
    >>> IP6_Address ('2001:0db8:1234:0000:0000:0000:0000:0000')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:1234:0000:0000:0000:0000:0000')
    >>> IP6_Address ('2001:0db8:1234:ffff:ffff:ffff:ffff:ffff')
    GTW.OMP.NET.IP6_Address (u'2001:0db8:1234:ffff:ffff:ffff:ffff:ffff')
    >>> IP6_Address ('2001:db8:a::123')
    GTW.OMP.NET.IP6_Address (u'2001:db8:a::123')
    >>> IP6_Address ('fe80::')
    GTW.OMP.NET.IP6_Address (u'fe80::')
    >>> IP6_Address ('::ffff:c000:280')
    GTW.OMP.NET.IP6_Address (u'::ffff:c000:280')
    >>> IP6_Address ('::')
    GTW.OMP.NET.IP6_Address (u'::')
    ...
    Invariants: `Syntax error` for : `IP6-address `address``
         ...
         got      value : `:::`
    IP6 address must contain up to 8 hexadecimal numbers with up to 4 digits separated by `:`. A single empty group `::` can be used.
    >>> IP6_Network ('1:2:3::/48')
    GTW.OMP.NET.IP6_Network (u'1:2:3::/48')
    >>> IP6_Network ('1:2:3::/128')
    GTW.OMP.NET.IP6_Network (u'1:2:3::/128')
    >>> IP6_Network ('1:2:3::/0')
    GTW.OMP.NET.IP6_Network (u'1:2:3::/0')
    >>> IP6_Network ('1:2:3::/129')
    Traceback (most recent call last):
     ...
    Invariants: `Syntax error` for : `IP6-network `address``
         expected type  : `IP6-network`
         got      value : `129`
    IP6 address must contain up to 8 hexadecimal numbers with up to 4 digits separated by `:`. A single empty group `::` can be used. This is optionally followed by `/` and a number between 0 and 128.
    >>> IP6_Network ('1:2:3::/1290')
    Traceback (most recent call last):
     ...
    Invariants: `Syntax error` for : `IP6-network `address``
         expected type  : `IP6-network`
