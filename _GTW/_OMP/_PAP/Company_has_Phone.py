...
#
# Purpose
#    Model the link between a company and a phone number
#
# Revision Dates
...
class Company_has_Phone (_Ancestor_Essence) :
    """Model the link between a company and a phone number"""
...
# end class Company_has_Phone

if __name__ != "__main__" :
    GTW.OMP.PAP._Export ("*")
### __END__ GTW.OMP.PAP.Company_has_Phone
