...
#
# Purpose
#    Model the link between a subject and an address
#
# Revision Dates
...
#    22-Mar-2012 (CT) Change from `Person_has_Address` to `Subject_has_Address`
#    ««revision-date»»···
#--
...
class Subject_has_Address (_Ancestor_Essence) :
    """Model the link between a subject and an address"""
    ...
    class _Attributes (_Ancestor_Essence._Attributes) :
        ...
        class right (_Ancestor.right) :
            """Address where subject lives or works"""
...
# end class Subject_has_Address

if __name__ != "__main__" :
    GTW.OMP.PAP._Export ("*")
### __END__ GTW.OMP.PAP.Subject_has_Address
